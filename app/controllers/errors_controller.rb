...
class ErrorsController < ApplicationController
  ...
  def show
    ...
    respond_to do |format|
      format.html { render template: 'errors/error', layout: 'layouts/application', status: @status_code }
      format.json { render json: { error: @exception.message }, status: @status_code }
    end
  end
