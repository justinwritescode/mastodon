...
# def csp_script_src
#   Rails.logger.debug { "ENV['CSP_SCRIPT_SRC'] raw value: #{ENV.fetch('CSP_SCRIPT_SRC', nil)}" }
#   logger_output = (ENV['CSP_SCRIPT_SRC'].presence || 'unsafe_inline http https *').split.compact
#   Rails.logger.debug { "Calculated csp_script_src: #{logger_output.inspect}" }
#   logger_output
# end

# def csp_content_src
#   (ENV['CSP_CONTENT_SRC'].presence || 'unsafe_inline http https *').split.compact
# end

# def csp_frame_src
#   (ENV['CSP_FRAME_SRC'].presence || '*').split.compact
# end

# def csp_media_src
#   (ENV['CSP_MEDIA_SRC'].presence || '*').split.compact
# end

# def csp_style_src
#   (ENV['CSP_STYLE_SRC'].presence || 'unsafe_inline http https *').split.compact
# end

# def csp_img_src
#   (ENV['CSP_IMG_SRC'].presence || '*').split.compact
# end

# def csp_font_src
#   (ENV['CSP_FONT_SRC'].presence || '*').split.compact
# end

# def csp_child_src
#   (ENV['CSP_CHILD_SRC'].presence || '*').split.compact
# end

# def csp_worker_src
#   (ENV['CSP_WORKER_SRC'].presence || '*').split.compact
# end

# def csp_connect_src
#   (ENV['CSP_CONNECT_SRC'].presence || '*').split.compact
# end
